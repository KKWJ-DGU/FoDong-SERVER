...
nohup java -jar \
  -Dspring.config.location=classpath:/application.yml,$REPOSITORY/src/main/resources/application-real.yml,$REPOSITORY/src/main/resources/application-jwt.yml \
